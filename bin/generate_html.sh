...
echo -n "<p>Last update: " >> output_html/index.html.tmp ; ls -lrt --full-time  output_html/playbooks/ | tail -n  1 | awk '{print $6" "$7}' >> output_html/index.html.tmp ; echo "</p><p><a href='feed.xml'>RSS Feed</p>" >> output_html/index.html.tmp
